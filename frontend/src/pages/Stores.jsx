            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+79258777838" className="text-sm hover:text-primary transition-colors">
                    8-925-877-78-38
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@kikicare.ru" className="text-sm hover:text-primary transition-colors">
                    info@kikicare.ru
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">ежедневно: 10:00 — 19:00</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://t.me/kikicare01" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://vk.com/kikicare" target="_blank" rel="noopener noreferrer"
                    className="text-sm hover:text-primary transition-colors">
                    vk.com/kikicare
                  </a>
                </div>
